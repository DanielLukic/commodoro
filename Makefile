...
TARGET = commodoro
BUILDDIR = build
# Remove src/timer.c, src/config.c, src/audio.c, and src/input_monitor.c from SOURCES as we're using Rust implementations
SOURCES = src/main.c src/tray_icon.c src/tray_status_icon.c src/settings_dialog.c src/break_overlay.c src/dbus_service.c src/dbus.c
# Remove timer.o, config.o, audio.o, and input_monitor.o from OBJECTS
OBJECTS = $(BUILDDIR)/main.o $(BUILDDIR)/tray_icon.o $(BUILDDIR)/tray_status_icon.o $(BUILDDIR)/settings_dialog.o $(BUILDDIR)/break_overlay.o $(BUILDDIR)/dbus_service.o $(BUILDDIR)/dbus.o
